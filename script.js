...
function animar_página(){
	...
	// Letras surgindo (independentes)
	const grupo_texto_slpit = document.querySelectorAll(".texto_split");

	grupo_texto_slpit.forEach((texto_unico_split) => {
		const split = SplitText.create(texto_unico_split, {
